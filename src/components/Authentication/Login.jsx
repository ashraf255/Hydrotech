...
const Login = () => {
  ...
  return (
    <>
      <div className="bg-white absolute w-full text-white-1400 px-6 lg:px-20">
        <Navbar></Navbar>
      </div>
      <div className="inputContainer pt-24 md:pt-10 min-h-[140svh] md:min-h-[100svh]">
        <section className="main flex flex-col px-10 py-6 mt-10">
          <form onSubmit={handleSubmit}>
            <h1 className="text-2xl font-semibold my-2 heading">Login</h1>
