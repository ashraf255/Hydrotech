...
const Homemiddle = () => {
  return (
	...
	<div className="flex flex-col max-w-3xl mx-auto overflow-hidden rounded">
		<img src="/Farm.png" alt="" className="w-full h-60 sm:h-96 bg-gray-500" />
		<div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md bg-gray-900">
			<div className="space-y-2">
				<a rel="noopener noreferrer" href="#" className="inline-block text-2xl font-semibold sm:text-3xl">Hydroponics system is the best solution for Soilless medium</a>
