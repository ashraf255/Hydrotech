        ...
        <div className="sm:mx-auto sm:container px-6 xl:px-0">
            <div className="flex items-center justify-between md:flex-row flex-col py-12 space-y-6 md:space-y-0 w-full ">
                <div className="hidden md:block">
                    <img className="hidden xl:block w-full" src="https://i.ibb.co/tzBDQVj/product1.jpg" alt="product" />
                    <img className="xl:hidden w-full" src="https://i.ibb.co/tzBDQVj/product1.jpg" alt="prodduct" />
                </div>
                <div className="flex justify-center items-center flex-col xl:w-2/5 md:px-6 sm:w-3/4 md:w-2/4">
                    ...
                    <div className="mt-8 flex justify-center items-center w-full">
                        <button className="hover:opacity-75 flex justify-center bg-gray-800 sm:w-32 w-full h-10 py-3"  onClick={handleExploreClick}>
                ...
                <div className="flex md:w-auto w-full justify-center flex-row space-x-4 md:space-x-0">
                    <div className="w-full">
                        <img className="hidden xl:block w-full h-96" src="https://i.ibb.co/zF2VVVC/product7.jpg" alt="product" />
                        <img className="xl:hidden w-full" src="https://i.ibb.co/zF2VVVC/product7.jpg" alt="product" />
                    </div>
