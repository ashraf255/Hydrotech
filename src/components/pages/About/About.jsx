        ...
        <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
          <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-gray-100 text-gray-800">
            <img
              ...
              src="https://i.ibb.co/pwqPdy8/ashraf.png"
            />
            <div className="flex-1 my-4">
              <p className="text-xl font-semibold leadi">Ashraf Mia</p>
              <p>Web developer and visual designer</p>
            </div>
          ...
          <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-gray-100 text-gray-800">
            <img
              alt=""
              className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full bg-gray-500"
              src="https://i.ibb.co/DY2Tqtw/mehedi.jpg"
            />
            <div className="flex-1 my-4">
              <p className="text-xl font-semibold leadi">Mehedi Hasan</p>
              <p>Web Developer</p>
            </div>
            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
              <a
          ...
          {/* <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-gray-100 text-gray-800">
            ...
            />
            <div className="flex-1 my-4">
              <p className="text-xl font-semibold leadi">Faysal Ahamed</p>
